...
def styles(faces):
    ...
    stc.STC_H_TAG:
     "fore:#336699,back:%(back)s,face:%(helv)s,size:%(size)d,bold" % faces,
    ...
    stc.STC_H_NUMBER:
     "fore:#cc0000,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    ...
    stc.STC_H_ENTITY:
     "fore:#336600,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_TAGEND:
     "fore:#000080,back:%(back)s,face:%(helv)s,size:%(size)d,bold" % faces,
    stc.STC_H_XMLSTART:
     "fore:#0000ff,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_XMLEND:
     "fore:#0000ff,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_SCRIPT:
     "fore:#000080,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_ASP:
     "fore:#000000,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_ASPAT:
     "fore:#000000,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_CDATA:
     "fore:#992222,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_QUESTION:
     "fore:#0000ff,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_VALUE:
     "fore:#ff00ff,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_XCCOMMENT:
     "fore:#007000,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    ...
    stc.STC_H_SGML_1ST_PARAM:
     "fore:#006600,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_SGML_DOUBLESTRING:
     "fore:#800000,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_SGML_SIMPLESTRING:
     "fore:#993300,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_SGML_ERROR:
     "fore:#800000,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_SGML_SPECIAL:
     "fore:#3366ff,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_SGML_ENTITY:
     "fore:#333333,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_SGML_COMMENT:
     "fore:#808000,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_SGML_1ST_PARAM_COMMENT:
     "fore:#808000,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_H_SGML_BLOCK_DEFAULT:
     "fore:#000066,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,

    stc.STC_HJ_START:
     "fore:#000033,back:%(back)s,face:%(helv)s,size:%(size)d,eolfilled" % faces,
    stc.STC_HJ_DEFAULT:
     "fore:#7F7F00,back:%(back)s,face:%(helv)s,size:%(size)d,bold,eolfilled" % faces,
    stc.STC_HJ_COMMENT:
     "fore:#3F7F3F,back:%(back)s,face:%(helv)s,size:%(size)d,italic" % faces,
    stc.STC_HJ_COMMENTLINE:
     "fore:#007F00,back:%(back)s,face:%(helv)s,size:%(size)d,italic" % faces,
    stc.STC_HJ_COMMENTDOC:
     "fore:#330000,back:%(back)s,face:%(helv)s,size:%(size)d,italic" % faces,
    stc.STC_HJ_NUMBER:
     "fore:#CC9900,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_HJ_WORD:
     "fore:#999999,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_HJ_KEYWORD:
     "fore:#00007f,back:%(back)s,face:%(helv)s,size:%(size)d,bold" % faces,
    stc.STC_HJ_DOUBLESTRING:
     "fore:#bF00bF,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_HJ_SINGLESTRING:
     "fore:#009F00,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_HJ_SYMBOLS:
     "fore:#999999,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    stc.STC_HJ_STRINGEOL:
     "fore:#BFBBB0,back:%(back)s,face:%(helv)s,size:%(size)d,eolfilled" % faces,
    stc.STC_HJ_REGEX:
     "fore:#660033,back:%(back)s,face:%(helv)s,size:%(size)d" % faces,
    ...
    #    "fore:#000000,back:%(back)s,face:%(helv)s,size:%(size)d,bold" % faces,
